 ...
 */
public class MeterForecastingData {
    ...
    public MeterForecastingData(long utcTimestamp, byte[] serialHash, float difference) {
    ...
    /**
     * Unix timestamp. It must be converted to the appropriate time zone before
     * aggregation.
     *
